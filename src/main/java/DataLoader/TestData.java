...
public class TestData {
    ...
    public static String dataFilePath =  System.getProperty("user.dir") + File.separator + "src" + File.separator +  "main"+ File.separator + "resources"+ File.separator + "DataManagement" + File.separator + "DataCSV"+ File.separator;

    public static String fieldsFilePath = System.getProperty("user.dir") + File.separator + "src" + File.separator +  "main"+ File.separator + "resources"+ File.separator + "DataManagement" + File.separator + "FieldsCSV"+ File.separator;
